                ...
                isLoading ? (
                    ...
                    <>
                        ...
                        <div className='w-full  py-20 flex items-center md:px-8 px-2  justify-center flex-col  '>
                            <div className='w-full h-40 bg-gray-50 text-red-600 font-bold flex items-center justify-center flex-col'>
                            ...
                            <div className='flex items-center  justify-center w-full py-10'>
                                <div className='flex w-full px-8 md:px-20 items-start md:flex-row flex-col md:justify-between justify-center'>
                                    ...
                                    <div className='md:px-4 mb-1 px-2 md:mx-2 flex flex-col items-start justify-center'>
                                        <div className='flex items-center justify-center mb-1'>
                                            <GoLocation className='text-xs font-semibold text-red-600' />
                                            <p className='font-semibold text-base mx-1'>Location </p>
                                            <p className=' text-sm text-gray-800 mx-1'>Rawalipindi</p>
                                        </div>
                                        <div className='flex items-center justify-center mb-1'>
                                            <MdCategory className='text-xs font-semibold text-red-600' />
                                    ...
                                    <div className='md:px-4 mb-1 px-2 md:mx-2 flex flex-col items-start justify-center'>
                                        <div className='flex items-center justify-center mb-1'>
                                            <BsBriefcaseFill className='text-xs font-semibold text-red-600' />
                                            <p className='font-semibold text-base mx-1'>Job Type </p>
                                            <p className='text-sm text-gray-800 mx-1'>{JobDetails?.job_type}</p>
                                        </div>
                                        <div className='flex items-center justify-center mb-1'>
                                            <AiOutlineDollarCircle className='text-xs font-semibold text-red-600' />
                                            <p className='font-semibold text-base mx-1'>compensation </p>
                                            <p className=' text-sm text-gray-800 mx-1'>$ {JobDetails?.compensation} </p>
                                        </div>
                                    </div>
                                    <div className='flex items-center justify-center'>
                                        {
                                            JobDetails?.user?.email === user?.email ? (
                                                ...
                                                <div className='flex items-center justify-center  '>
                                                    <BsFillBookmarkCheckFill onClick={handleBookMark} className='text-red-600 text-4xl cursor-pointer  mx-2'/>
                                                    <button onClick={handleApply} className='md:px-6 md:py-3 px-3 py-2 mt-2 md:mt-0 bg-red-500 rounded text-base tracking-widest uppercase transition-all duration-700 hover:bg-red-900 text-white  '>Apply Position</button>
                                                </div>
                                            )
                                        }
                                    </div>
                            ...
                            <div className='w-full md:px-4 py-2 flex items-center md:items-start md:flex-row flex-col justify-start md:justify-center'>
                                <div className='md:w-8/12 w-full md:px-4 py-8 flex flex-col items-center content-start justify-center '>
                                    <h1 className='text-center lg:text-2xl font-semibold text-xl mb-4 uppercase border-b-2 border-red-600 py-2'>Job Description</h1>
                                ...
                                <div className='md:w-4/12 w-full py-8 px-4 md:px-10'>
                                    ...
                                    <div className='flex items-center justify-start mb-3'>
                                        <RiUserSearchFill className='text-base font-semibold text-red-600' />
                                    ...
                                    <div className='flex items-center justify-start mb-3'>
                                        <BsFillCalendar2DateFill className='text-base font-semibold text-red-600' />
                                        <p className='font-semibold text-base mx-1'>Dead Line</p>
                                        <p className=' text-sm text-gray-800 mx-1'>{new Date(`${JobDetails?.application_cutoff_date}`).toLocaleDateString('en-GB')}</p>
                                    </div>
                                    <div className='flex items-center justify-start mb-3'>
                                        <HiOutlineStar className='text-base font-semibold text-red-600' />
                                                ...
                                                <div key={item?._id} className='md:w-96 w-full py-3 mx-4 my-2 flex items-center md:items-start px-6 justify-start md:justify-center flex-col rounded bg-gray-50'>
                                                    ...
                                                    <div className='flex flex-col px-1 md:px-4 py-6 items-start justify-center'>
                                                        <div className='flex px-1 md:px-4 items-center justify-start mb-2'>
                                                            <BsBriefcaseFill className='text-base font-semibold text-red-600' />
                                                        ...
                                                        <div className='flex px-1 md:px-4 items-center justify-center mb-2'>
                                                            <AiOutlineDollarCircle className='text-base font-semibold text-red-600' />
                                                            <p className='font-semibold text-xs md:text-base mx-1'>compensation </p>
                                                            <p className=' text-sm text-gray-800 mx-1'>{item?.compensation}</p>
                                                        </div>
                                                        <div className='flex px-1 md:px-4 items-center justify-center mb-2'>
                                                            <RiUserSearchFill className='text-base font-semibold text-red-600' />
                                                        ...
                                                        <div className='flex px-1 md:px-4 items-center justify-center mb-2'>
                                                            ...
                                                            <p className=' text-xs text-gray-800 mx-1'>{new Date(`${item?.application_cutoff_date}`).toLocaleDateString('en-GB')}</p>
                                                        </div>
                                                    </div>
                                                    <button onClick={() => router.push(`/frontend/jobDetails/${item?._id}`)} className='my-2 py-2 px-4  border border-red-600 uppercase  rounded flex items-center justify-center transition-all duration-700 hover:bg-red-600 hover:text-white text-red-600 font-semibold'>View Detail<AiOutlineArrowRight className='mx-2 text-xl' /></button>
                                                </div>
                                            )
                                        })
                                        )
